...
private:
    ...
    bool IsLocalVertex(
        const SSInt local_x, const SSInt local_y, const SSInt local_z, const SInt xs, const SInt ys, const SInt zs) {
    ...
    SInt LocateVertexInChunk(
        const SInt chunk, const SInt local_x, const SInt local_y, const SInt local_z, Direction direction) {
        SInt offset = OffsetForChunk(chunk);
