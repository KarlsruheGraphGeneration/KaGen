...
//
//         // An uneven number of bits would require a more difficult to implement unbalanced Feistel network. We
//         sacrifice
...
//         // We might get a number which is greater than max_value when cycle walking. In the case max_value's MSB is
//         at
//         // an uneven position, we could even get a value which's MSB is at a lefter position than max_values's. This
//         is
//         // due to our simplification of using an extra bit to avoid an unbalanced Feistel network. We therefore can
//         only
