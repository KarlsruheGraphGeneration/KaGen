...
public:
    ...
    EdgeList GenerateDirectedGNM(
        SInt n, SInt m, SInt k = 0, SInt seed = 1, const std::string& output = "out", bool self_loops = false) {
        EdgeList edges;
    ...
    EdgeList GenerateUndirectedGNM(
        SInt n, SInt m, SInt k = 0, SInt seed = 1, const std::string& output = "out", bool self_loops = false) {
        EdgeList edges;
    ...
    EdgeList GenerateDirectedGNP(
        SInt n, LPFloat p, SInt k = 0, SInt seed = 1, const std::string& output = "out", bool self_loops = false) {
        EdgeList edges;
    ...
    EdgeList GenerateUndirectedGNP(
        SInt n, LPFloat p, SInt k = 0, SInt seed = 1, const std::string& output = "out", bool self_loops = false) {
        EdgeList edges;
    ...
    EdgeList Generate2DRGG(SInt n, LPFloat r, SInt k = 0, SInt seed = 1, const std::string& output = "out") {
        EdgeList edges;
    ...
    EdgeList Generate3DRGG(SInt n, LPFloat r, SInt k = 0, SInt seed = 1, const std::string& output = "out") {
        EdgeList edges;
...
#ifdef KAGEN_CGAL_FOUND
    EdgeList Generate2DRDG(SInt n, SInt k = 0, SInt seed = 1, const std::string& output = "out") {
        // Update config
        config_.n           = n;
        config_.k           = (k == 0 ? config_.k : k);
        config_.seed        = seed;
    ...
    EdgeList Generate3DRDG(SInt n, SInt k = 0, SInt seed = 1, const std::string& output = "out") {
        EdgeList edges;
    ...
    EdgeList GenerateBA(SInt n, SInt d, SInt k = 0, SInt seed = 1, const std::string& output = "out") {
        EdgeList edges;
    ...
    EdgeList GenerateRHG(SInt n, LPFloat gamma, SInt d, SInt k = 0, SInt seed = 1, const std::string& output = "out") {
        EdgeList edges;
    ...
    EdgeList Generate2DGrid(
        SInt n, SInt m, LPFloat p, SInt periodic, SInt k = 0, SInt seed = 1, const std::string& output = "out") {
        EdgeList edges;
